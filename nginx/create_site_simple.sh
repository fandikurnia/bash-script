...
#WEB_DIR='/var/www'
read -r -p "Apakah sudah mempunyai web directory? [y/N] " response 
case $response in 
	[yY][eE][sS]|[yY])
		#echo berhasil;	
		read -r -p "Input your web Directory : " WEB_DIR
		echo $WEB_DIR
		;; 
 	*)
		echo "Default Web Directory akan diarahkan ke /var/www/html"
